<div class="product__buynow-popup">
    <div class="product__buynow-popup--info">
        <div class="img">
    ...
    <div class="product__buynow-popup--btn">
        <a href="javascritp:(0)" class="buy-btn  add-to-cart" data-name="{{$productDetail->name}}" data-price="{{$productDetail->price}}" data-discount="{{$productDetail->discount}}" data-image="{{$productDetail->image}}" data-uuid="{{$productDetail->uuid}}" data-combo="{{$bonusCombojson}}">MUA NGAY</a>
