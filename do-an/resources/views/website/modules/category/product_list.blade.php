       ...
       @endphp
            ...
            <a href="{{route('product', $product->slug)}}">
                ...
                <div class="img">
                    @if ($product->image != null)
                        <img class="lozad" data-src="{{$product->image}}" alt="{{$product->name}}">
                    @else
                        <img class="lozad" data-src="{{$config->value}}" alt="{{$product->name}}">
                    @endif
                </div>
                <div class="hot-deal">
                    @if (strpos($product->featured,'6'))
                        <img class="hot-deal lozad"  data-src="{{asset('website/img/hot-deal.png')}}" alt="{{$product->name}}">
                    @endif
                </div>
                <div class="info">
                    <div class="name">
        ...
        <li>
            <a href="{{route('product',$product->slug)}}">
                ...
                <div class="hot-deal">
                    @if (strpos($product->featured,'6'))
                        <img class="lozad" data-src="{{asset('website/img/hot-deal.png')}}" alt="{{$product->name}}">
                    @endif 
                </div>
                <div class="name">
                    <span>{{$product->name}}</span>
