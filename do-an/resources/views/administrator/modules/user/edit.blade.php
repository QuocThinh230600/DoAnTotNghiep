...
@section('content')
    <form action="{{ route('admin.user.update', ['user' => $user->uuid]) }}" method="POST" enctype="multipart/form-data" class="formAjax checkpass">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <x-card title="action.info" id="forms-target-left">
                    ...
                    <x-text label="user.password_confirm" type="password" disabled='disabled' name="password_confirmation" placeholder="user.password_confirm" required="required">
