<div class="alert bg-danger alert-styled-left alert-dismissible print-error-msg" style="display: none; background:#f8d7da; color:#721c24;border-color: #f5c6cb;    line-height: 30px; padding:10px">
    <ul class="mb-0"></ul>
</div>
