        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="bg-light">
                        <ul class="nav nav-tabs nav-tabs-bottom mb-0">
                            ...
                            <li class="nav-item">
                                <a href="#card-toolbar-tab4" class="nav-link" data-toggle="tab">
                                    <i class="icon-gift mr-2"></i>
                                    {{ behavior('action.bonus_product') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#card-toolbar-tab5" class="nav-link" data-toggle="tab">
                                    <i class="icon-ticket mr-2"></i>
                                    {{ behavior('action.promotion') }}
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body tab-content" id="forms-target-left">
                        ...
                        <div class="tab-pane fade" id="card-toolbar-tab3">
                            <x-attribute :data="$attribute"></x-attribute>
                        </div>
                        <div class="tab-pane fade" id="card-toolbar-tab4">
                            <x-bonusproduct :data="$bonusproduct"></x-bonusproduct>
                        </div>
                        <div class="tab-pane fade" id="card-toolbar-tab5">
                            <x-promotion  :data="$promotion"></x-promotion>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <x-card :module="$category_name" id="forms-target-right">
                    ...
                    @else
                        @php
                        recursionList($categories, $category_product,4)
                        @endphp
                    @endif
                </x-card>
                ...
                <x-card title="action.info" id="forms-target-right">
                    <x-selectbox label="product.producer" name="producer_id" :dataSelect="$producer" required="required">
                        {{ old('producer', $product->producer_id) }}
                    </x-selectbox>

                    <x-selectbox label="product.parent" name="parent_id" :dataSelect="$parent"  choose="1">
                        {{ old('parent', $product->parent_id) }}
                    </x-selectbox>

                    <x-selectbox label="element.installment" name="installment" :dataSelect="installment()">
                        {{ old('installment', $product->installment) }}
                    </x-selectbox>
