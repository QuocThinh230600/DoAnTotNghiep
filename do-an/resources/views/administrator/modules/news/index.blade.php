        ...
        <table class="table table-hover datatable-colvis-basic" url="{{ route('admin.ajax.newsDataTables') }}">
            ...
            <tfoot>
                <tr>
                    ...
                    <th data="image" name="image" orderable="false" ></th>
                    <th type="text" data="title" name="title" orderable="false">{{ label('news.title') }}</th>
                    <th type="select" data="category" name="category" orderable="false" >
                        <select class="form-control" name="category">
                            <option value="">{{ label('please_choose') }}</option>
                            @php
                                recursiveSelectDatatable($category, old('category'),2)
                            @endphp
                        </select>
                    </th>
                    ...
                    <th type="select" data="featured" name="featured"  orderable="false">
                        <select class="form-control">
                            <option value="">{{ label('please_choose') }}</option>
