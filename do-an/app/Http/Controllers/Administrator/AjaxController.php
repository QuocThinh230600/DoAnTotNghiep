...
/**
    ...
    {
        $data["id"] = $request->id;
        $view       = view('components.ajax_product', $data)->render();
    ...
    public function addRowUploadBonusProduct(Request $request)
    {
        $data["id"] = $request->id;
        $view       = view('components.ajax_bonus_product', $data)->render();
    ...
    public function addRowUploadPromotion(Request $request)
    {
        $data["id"] = $request->id;
        $view       = view('components.ajax_promotion', $data)->render();
