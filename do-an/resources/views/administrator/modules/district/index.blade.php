        ...
        <table class="table table-hover datatable-colvis-basic" url="{{ route('admin.ajax.districtDataTables') }}">
            ...
            <tfoot>
                <tr>
                    ...
                    <th type="text" data="provinces" name="provinces" orderable="false" >{{ label('province.name') }}</th>
                    <th type="text" data="name" name="name" orderable="false" >{{ label('district.name') }}</th>
