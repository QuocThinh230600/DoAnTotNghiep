<div class="row mb-2 row-upload-multi" data-id="{{ $id }}" id="row-upload-multi-image-{{ $id }}">
    <div class="col-md-2">
        <div class="card-img-actions mx-1 mt-1">
            ...
            <div class="card-img-actions-overlay card-img">
                <a href="{{ $imageDefault }}" target="_blank" id="image-upload-{{ $id }}" class="btn btn-outline bg-white text-white border-white border-2 btn-icon rounded-round" data-popup="lightbox" rel="group-image">
    ...
    <div class="col-md-3 my-auto">
        <select name="multi_images[{{ $id }}][image_position]" class="form-control">
            <option value="1">Ảnh phụ</option>
            <option value="2">Ảnh thông số kĩ thuật</option>
            <option value="3">Ảnh mô tả</option>
        </select>
    </div>
