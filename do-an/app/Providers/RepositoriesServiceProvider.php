...
use App\Repositories\ShowRoom\EloquentShowRoom;
...
use App\Repositories\BonusProduct\EloquentBonusProduct;
...
use App\Repositories\BonusProduct\BonusProductRepository;
...
use App\Repositories\QuestionProduct\EloquentQuestionProduct;
...
use App\Repositories\Promotion\EloquentPromotion;
...
class RepositoriesServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ShowRoomRepository::class,EloquentShowRoom::class);
        $this->app->bind(QuestionProductRepository::class,EloquentQuestionProduct::class);
        $this->app->bind(ReviewRepository::class,EloquentReview::class);
        $this->app->bind(BonusProductRepository::class,EloquentBonusProduct::class);
        $this->app->bind(PromotionRepository::class,EloquentPromotion::class);
    }
