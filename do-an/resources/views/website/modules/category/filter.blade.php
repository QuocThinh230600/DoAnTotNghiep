<div class="category__product-filter">
    ...
    <div class="filter-right">
        <div class="filter-right__item">
            <select name="attribute_sort" id="pricePro" class="resizeselect" data-url="{{route('ajax-filter')}}" data-idCat="{{isset($catId)? $catId :''}}"  data-idProducer="{{isset($idProducer)? $idProducer : ''}}" >
        ...
        @foreach ($attribute as $attr)
            <div class="filter-right__item">
                <select class="attribute_sort resizeselect" name="attribute_sort" id="" data-attr="{{$attr['attr']->id}}">
        ...
        <div class="filter-sort">
            <select name="attribute_sort" id="sort_filter" data-url={{ route('ajax-filter') }} data-cateId={{ $catId }}>
