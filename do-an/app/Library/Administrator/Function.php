        ...
        foreach ($data as $key => $item) {
            if ($item->parent_id == $parent_id) {
                ...
                if ($item->featured == 3) {
                    ...
                    echo '<td><span class="badge badge-secondary">' . label('element.status_disable_filter') . '</span></td>';
                }
...
if (!function_exists('recursiveSelectProduct')) {
    /**
     * Show select option recursive
     * @param $data
     * @param $selected
...
if (!function_exists('showStar')) {
    ...
    function showStar($number)
    {
        ...
        $xhtml= '';
        for ($i=0; $i < $number ; $i++) { 
            $xhtml.='<svg class="active" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="15"
            height="15" x="0" y="0" viewBox="0 0 511.98685 511"
            ...
            <g>
                <path xmlns="http://www.w3.org/2000/svg"
                    ...
                    fill="#ddd" data-original="#ffc107" class="" />
            </g>
        </svg>';
        }
        for ($i=0; $i < 5-$number ; $i++) { 
            $xhtml.= '<svg xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="15"
            height="15" x="0" y="0" viewBox="0 0 511.98685 511"
            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
