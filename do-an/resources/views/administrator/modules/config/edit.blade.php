        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <x-card title="action.info" id="forms-target-right">
                    ...
                    <x-text label="config.twitter" type="text" name="twitter" placeholder="config.twitter">
                        {{ old('twitter', $config["twitter"]) }}
                    </x-text>
                    ...
                    <x-text label="config.google_plus" type="text" name="google_plus" placeholder="config.google_plus">
                        {{ old('google_plus', $config["google_plus"]) }}
                    </x-text>
                </x-card>
