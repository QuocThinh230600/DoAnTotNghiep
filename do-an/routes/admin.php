...
Route::resource('questionProduct', 'QuestionProductController');
...
Route::post('review-change-status/{review}', 'ReviewController@changeStatus')->name('reviewChangeStatus');
Route::get('change-status-order/{uuid}/{status}','CartController@change_status_order')->name('changestatusorder');
...
Route::prefix('showRoom')->name('showRoom.')->group(function () {
    Route::put('update/{showRoom}', 'ShowRoomController@update')->name('update.news');
});
...
Route::prefix('ajax')->name('ajax.')->group(function () {
    ...
    Route::get('promotions-datatables', 'PromotionController@dataTableIndex')->name('promotionDataTables');
    Route::get('showroom-datatables', 'ShowRoomController@dataTableIndex')->name('ShowRoomController');
    Route::get('get-cart', 'CartController@dataTableIndex')->name('CartController');
    Route::get('getCoupon', 'CouponController@dataTableIndex')->name('getCoupon');
    ...
    Route::get('showroom-datatables', 'ShowRoomController@dataTableIndex')->name('showRoomDataTables');
    Route::get('questionproduct-datatables', 'QuestionProductController@dataTableIndex')->name('questionProductDataTables');
    Route::get('review-datatables', 'ReviewController@dataTableIndex')->name('reviewDataTables');
    ...
    Route::post('add-row-upload-product', 'AjaxController@addRowUploadProduct')->name('addRowUploadProduct');
    ...
    Route::post('add-row-upload-bonusproduct', 'AjaxController@addRowUploadBonusProduct')->name('addRowUploadBonusProduct');
    Route::post('add-row-upload-promotion', 'AjaxController@addRowUploadPromotion')->name('addRowUploadPromotion');
