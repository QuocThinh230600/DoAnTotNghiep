        ...
        <table class="table table-hover datatable-colvis-basic" url="{{ route('admin.ajax.producerDataTables') }}">
            ...
            <tfoot>
                <tr>
                    ...
                    <th type="text" data="name" name="name" orderable="false" >{{ label('producer.name') }}</th>
                    <th type="text" data="address" name="address" orderable="false" >{{ label('producer.address') }}</th>
                    <th type="text" data="email" name="email" orderable="false" >{{ label('producer.email') }}</th>
