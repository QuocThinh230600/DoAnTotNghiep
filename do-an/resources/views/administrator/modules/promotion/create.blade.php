...
@section('title', title_module('promotion', 'create'))
    ...
    @canany(['promotion_index', 'promotion_edit', 'promotion_destroy'])
        ...
        @section('content')
            <form action="{{ route('admin.promotion.store') }}" method="POST" enctype="multipart/form-data" class="formAjax">
                @csrf
                @method('POST')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body tab-content" id="forms-target-left">
                                <div class="tab-pane fade show active" id="card-toolbar-tab1">
                                    <x-text label="news.title" type="text" name="title" placeholder="news.title" slug="slug_name"
                                        title="title_name" required="required">
                                        {{ old('title') }}
                                    </x-text>

                                    <div class="row">
                                        <div class="col-lg-6">
                                            <x-text label="promotion.main" type="text" name="author" placeholder="promotion.main"
                                                required="required">
                                        ...
                                        <div class="col-lg-6">
                                            <x-text label="promotion.promotion_percent" type="number" name="promotion_percent"
                                                placeholder="promotion.promotion_percent">
                                                {{ old('promotion_percent') }}
                                            </x-text>
                                        </div>
                                    </div>
