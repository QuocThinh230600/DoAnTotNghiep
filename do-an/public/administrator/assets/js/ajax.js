...
let AjaxJS = function () {
    ...
    let _componentMultiUploadBonusProduct = function () {
        $("#add-row-upload-bonusproduct").click(function () {
            let url = $(this).data('url'),
                id,
                $id_row = $('.module-upload-multi-bonusproduct .row-upload-multi');
            ...
            $.ajax({
                ...
                data: {id: id},
                success: function (result) {
                    $("#load-row-upload-bonusproduct").append(result.view);
                }
            });
        });
    ...
    let _componentMultiUploadPromotion = function () {
        $("#add-row-upload-promotion").click(function () {
            let url = $(this).data('url'),
                id,
                $id_row = $('.module-upload-multi-promotion .row-upload-multi');
            ...
            $.ajax({
                ...
                data: {id: id},
                success: function (result) {
                    $("#load-row-upload-promotion").append(result.view);
                }
            });
        });
    ...
    return {
        init: function () {
            ...
            _componentMultiUploadBonusProduct();
            _componentMultiUploadPromotion();
        }
    };
}();
